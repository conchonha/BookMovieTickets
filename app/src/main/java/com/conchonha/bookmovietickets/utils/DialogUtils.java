...
import com.conchonha.bookmovietickets.base.data.IActionSuccess;
import com.conchonha.bookmovietickets.databinding.DialogConfirmAlertBinding;

public class DialogUtils {
    public static void showAlertDialog(Context context, String message, IActionSuccess success){
