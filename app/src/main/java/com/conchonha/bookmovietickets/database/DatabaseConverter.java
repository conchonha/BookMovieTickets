...
public class DatabaseConverter {
    ...
    @TypeConverter
    public String fromListChair(Set<Integer> listChair) {
        Gson gson = new Gson();
        return gson.toJson(listChair);
    }

    @TypeConverter
    public Set<Integer> toListChair(String listChair) {
        Gson gson = new Gson();
        Type type = new TypeToken<Set<Integer>>() {}.getType();
        return gson.fromJson(listChair, type);
    }
}
